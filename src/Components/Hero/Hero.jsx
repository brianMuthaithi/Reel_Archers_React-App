      ...
      >
        <div className="overflow-hidden relative flex flex-col h-full justify-center mx-auto max-w-5xl md:overflow-visible xl:max-w-7xl">
          <div className="flex flex-row items-center justify-center">
            ...
            <h2 className="font-semibold text-[#ff9100] text-3xl -m-6 md:-ml-10 md:text-5xl">
              eel Archer Studios
            </h2>
          </div>
          <div className="flex flex-col-reverse  justify-center h-max md:flex-row md:space-x-10">
            <div className="mt-3 text-center flex flex-col px-2 space-y-10  md:px-0 md:mt-0">
              <h2 className="text-2xl text-white font-bold mx-auto md:w-3/4 xl:text-4xl">
                Delivering High Quality, Effective And Inspiring Built Space To
                Appeal And Preserve The Best In Architecture...
              </h2>
              <p className="text-base text-white my-4 mx-auto md:w-3/4 lg:text-base xl:text-xl">
              ...
              <Link
                to="contact us"
                className="hover:bg-[#ff9100] border-[#ff9100] border w-max mx-auto rounded-3xl py-2 px-6 text-[#000000] xl:text-lg hover:text-[#2A0800] font-bold bg-[#ff9100] duration-500"
              >
                Contact Us
              </Link>
            </div>
