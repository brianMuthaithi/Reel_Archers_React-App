    ...
    <section>
      ...
      <div className="mx-auto mt-10 px-2 max-w-5xl lg:px-2 xl:max-w-7xl">
        <h2 className="title text-gray-800 text-4xl font-bold text-center xl:text-5xl">
          About <span className="text-[#ff9100]">Reel Archer Studios</span>
        </h2>
        <div
        ...
        >
          {values.map((value, i) => (
            <div
              className="flex flex-col text-center bg-[#3d3c3aa9] p-5 rounded-xl md:w-1/2 hover:scale-95 duration-700"
              key={i}
            >
              <img
                src={value.image}
              ...
              />
              <h2 className="fonto text-[#ff9100] text-lg font-semibold">
                {value.name}
              </h2>
        ...
        >
          ...
          <p className="mt-5 text-center text-white mx-auto md:w-[80%] xl:text-lg">
          ...
          <div className="flex flex-col gap-5  mt-10 md:flex-row">
            {teams.map((team, i) => (
              <div
                key={i}
                className="border-4 border-[#3d3c3aa9]  p-5 text-center space-y-2 rounded-xl md:w-1/3 hover:shadow-2xl duration-700"
              >
                <img
                  src={team.image}
                  alt=""
                ...
                <h2 className="text-lg font-semibold text-[#f5c855] italic">{team.role}</h2>
                <p className="text-white">{team.text}</p>
              </div>
            ))}
          </div>
        </div>
        <div className="py-16 text-[#f5c855]">
          <div className="bg-[#3d3c3aa9] flex flex-row justify-between items-center rounded-xl p-5">
            <div>
            ...
            <div>
              <button className="bg-white py-2 px-5 rounded-full font-bold text-[#2A0800] md:text-xl hover:bg-transparent hover:border hover:border-white hover:text-white duration-700">
